...
export default function PaymentSuccess() {
  ...
  useEffect(() => {
    ...
    document.title = isEn
      ...
      : "✨ Platba úspěšná — Vítejte v Premium!";
        ...
        <div className="container max-w-3xl text-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-xl mx-auto">
              {isBlueprint
                ? isEn
                  ? "Marie will guide you through your personal report. Open a saved chart to download your PDF and continue with five in-depth AI readings."
                  : "Marie vás provede osobním reportem. Otevřete uloženou mapu, stáhněte si PDF a pokračujte pěti hloubkovými AI výklady."
                : isEn
          ...
          >
            {(isBlueprint
              ? [
                  {
                    icon: "📄",
                    label: isEn ? "Premium PDF report" : "Prémiový PDF report",
                  },
                  {
                    icon: "✨",
                    label: isEn
              ...
              : [
                  {
                    ...
                    label: isEn
                      ? "Generous AI access"
                      : "Velkorysý přístup k AI výkladům",
                  },
                  {
                    icon: "📄",
                    label: isEn ? "PDF chart reports" : "PDF reporty mapy",
                  },
                  {
                    icon: "🛠️",
                    label: isEn
                      ? "All premium tools"
                      : "Všechny prémiové nástroje",
                  },
                ]
            ).map((item, i) => (
              ...
              <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  <div className="mb-2 flex items-center gap-2 text-sm font-semibold text-amber-800 dark:text-amber-300">
                    ...
                    {isEn
                      ? "Private 48-hour offer"
                      : "Soukromá nabídka na 48 hodin"}
                  </div>
                  <h2 className="font-serif text-2xl font-semibold">
                    {isEn
                      ? "Turn your Blueprint into Annual Premium"
                      : "Převeďte Blueprint na roční Premium"}
                  </h2>
