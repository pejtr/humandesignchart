...
const CELEBRITIES = [
  { name: "Albert Einstein", birthDate: "1879-03-14", birthTime: "11:30", birthPlace: "Ulm, Německo", lat: 48.4011, lon: 9.9876, tz: 1, photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/28/Albert_Einstein_Head_cleaned.jpg/200px-Albert_Einstein_Head_cleaned.jpg" },
  ...
  { name: "Elon Musk", birthDate: "1971-06-28", birthTime: "06:00", birthPlace: "Pretoria, Jižní Afrika", lat: -25.7479, lon: 28.2293, tz: 2, photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Elon_Musk_-_54820081119_%28cropped%29.jpg/250px-Elon_Musk_-_54820081119_%28cropped%29.jpg" },
  ...
  { name: "Steve Jobs", birthDate: "1955-02-24", birthTime: "19:15", birthPlace: "San Francisco, Kalifornie, USA", lat: 37.7749, lon: -122.4194, tz: -8, photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/dc/Steve_Jobs_Headshot_2010-CROP_%28cropped_2%29.jpg/200px-Steve_Jobs_Headshot_2010-CROP_%28cropped_2%29.jpg" },
  { name: "Princezna Diana", birthDate: "1961-07-01", birthTime: "19:45", birthPlace: "Sandringham, Norfolk, UK", lat: 52.8242, lon: 0.5134, tz: 1, photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Diana%2C_Princess_of_Wales_1997_%282%29.jpg/250px-Diana%2C_Princess_of_Wales_1997_%282%29.jpg" },
  { name: "Barack Obama", birthDate: "1961-08-04", birthTime: "19:24", birthPlace: "Honolulu, Havaj, USA", lat: 21.3069, lon: -157.8583, tz: -10, photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/President_Barack_Obama.jpg/200px-President_Barack_Obama.jpg" },
  { name: "Taylor Swift", birthDate: "1989-12-13", birthTime: "05:17", birthPlace: "Reading, Pensylvánie, USA", lat: 40.3356, lon: -75.9269, tz: -5, photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b1/Taylor_Swift_at_the_2023_MTV_Video_Music_Awards_%283%29.png/250px-Taylor_Swift_at_the_2023_MTV_Video_Music_Awards_%283%29.png" },
  { name: "Leonardo da Vinci", birthDate: "1452-04-15", birthTime: "03:00", birthPlace: "Vinci, Itálie", lat: 43.7874, lon: 10.9237, tz: 1, photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/cb/Francesco_Melzi_-_Portrait_of_Leonardo.png/250px-Francesco_Melzi_-_Portrait_of_Leonardo.png" },
  { name: "Nikola Tesla", birthDate: "1856-07-10", birthTime: "00:00", birthPlace: "Smiljan, Chorvatsko", lat: 44.5655, lon: 15.3172, tz: 1, photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/79/Tesla_circa_1890.jpeg/200px-Tesla_circa_1890.jpeg" },
  { name: "Mahátma Gándhí", birthDate: "1869-10-02", birthTime: "07:12", birthPlace: "Porbandar, Indie", lat: 21.6417, lon: 69.6293, tz: 5, photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7a/Mahatma-Gandhi%2C_studio%2C_1931.jpg/250px-Mahatma-Gandhi%2C_studio%2C_1931.jpg" },
  ...
  { name: "Nelson Mandela", birthDate: "1918-07-18", birthTime: "12:00", birthPlace: "Mvezo, Jižní Afrika", lat: -31.9505, lon: 28.7780, tz: 2, photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/02/Nelson_Mandela_1994.jpg/250px-Nelson_Mandela_1994.jpg" },
  { name: "Angelina Jolie", birthDate: "1975-06-04", birthTime: "09:09", birthPlace: "Los Angeles, Kalifornie, USA", lat: 34.0522, lon: -118.2437, tz: -8, photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1f/Angelina_Jolie_at_the_2024_Toronto_International_Film_Festival_%28cropped%29.jpg/200px-Angelina_Jolie_at_the_2024_Toronto_International_Film_Festival_%28cropped%29.jpg" },
  ...
  { name: "Dalajláma", birthDate: "1935-07-06", birthTime: "04:38", birthPlace: "Taktser, Tibet", lat: 36.4000, lon: 102.7833, tz: 8, photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/The_Dalai_Lama_in_2012.jpg/250px-The_Dalai_Lama_in_2012.jpg" },
  { name: "Frida Kahlo", birthDate: "1907-07-06", birthTime: "08:30", birthPlace: "Coyoacán, Mexiko", lat: 19.3500, lon: -99.1621, tz: -6, photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/06/Frida_Kahlo%2C_by_Guillermo_Kahlo.jpg/250px-Frida_Kahlo%2C_by_Guillermo_Kahlo.jpg" },
              ...
              {!selectedCeleb ? (
                <Card className="bg-white border-border/30 shadow-sm">
                  <CardContent className="py-20 text-center">
                    ...
                    <p className="text-muted-foreground text-lg">Vyberte celebritu pro zobrazení jejího Human Design chartu.</p>
                    <p className="text-muted-foreground/60 text-sm mt-2">Klikněte na jméno v seznamu vlevo</p>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-white border-border/30 shadow-sm">
                  ...
                  <CardContent>
                    ...
                    <div className="flex items-center gap-3 mb-5 p-4 rounded-xl bg-gradient-to-r from-primary/5 to-transparent border border-primary/10">
                      ...
                      <div>
                        <p className="text-xs text-muted-foreground uppercase tracking-wider">Typ</p>
                    ...
                    <div className="border-t border-border/30 pt-4">
                      <p className="text-xs text-muted-foreground uppercase tracking-wider mb-3">Centra</p>
