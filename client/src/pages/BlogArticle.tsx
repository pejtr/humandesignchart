                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {seriesArticles.map((sa, idx) => (
                    <Link
                      ...
                      className={`no-underline flex items-center gap-2.5 px-3 py-2 rounded-lg transition-colors text-sm ${
                        sa.slug === article.slug
