...
Human Design je unikátní systém sebepoznání, který vznikl v roce 1987, když kanadský fyzik **Ra Uru Hu** (vlastním jménem Robert Alan Krakower) zažil mystický zážitek na španělském ostrově Ibiza. Během osmi dní a nocí přijal informace, které později formuloval do komplexního systému mapujícího lidskou energii.

![Ibiza — mystický ostrov ve Středozemí, kde vznikl Human Design](https://images.unsplash.com/photo-1539037116277-4db20889f2d4?w=1200&q=80&auto=format&fit=crop)
...
Prvním krokem je nechat si **[vypočítat svou mapu](/cs/calculate)** pomocí naší **[Human Design kalkulačky](/cs/calculate)**. K tomu potřebujete přesné datum, čas a místo narození. Čím přesnější čas, tím přesnější mapa — ideálně z rodného listu.
...
Human Design není víra ani dogma — je to experiment. Ra Uru Hu vždy říkal: „Nevěřte mi, vyzkoušejte si to sami." Nejlepší způsob, jak ověřit platnost systému, je žít podle své strategie a autority po dobu alespoň 3-6 měsíců a pozorovat, co se změní.`,
  },
  {
    ...
    metaTitle: "5 typů Human Designu + TEST: Zjistěte svůj typ za 2 minuty [Generátor, Projektor…]",
    metaDescription: "Který z 5 typů Human Designu jste? Generátor, Projektor, Manifestor nebo Reflektor? Spočítejte si typ zdarma a poznejte svou strategii i životní roli.",
...
![Objevujte svůj typ na pozadí mystické krajiny — cesta sebepoznání začíná zde](https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&q=80&auto=format&fit=crop)
...
![Reflektor — čisté jezero v srdci přírody, ideální prostředí pro zrcadlení energií](https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=1200&q=80&auto=format&fit=crop)
...
![Energetická centra těla — symbolizována světlem protkávanou krajinou](https://images.unsplash.com/photo-1518684079-3c830dcef090?w=1200&q=80&auto=format&fit=crop)
...
5. **Dejte si prostor** — každý potřebuje čas sám se sebou, zejména pro „dekondicionování" od partnerovy energie.`,
  },
  {
    ...
    metaTitle: "Inkarnační kříž v Human Designu: Jak najít svůj životní účel? [Průvodce]",
    metaDescription: "Co je inkarnační kříž a jak odhaluje váš životní účel? Pravý, levý úhlový a juxtapoziční kříž jednoduše vysvětleny. Spočítejte si svůj kříž zdarma.",
...
![Cesta k životnímu účelu — slunce vycházející nad horami, symbol vašeho inkarnačního kříže](https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=1200&q=80&auto=format&fit=crop)
