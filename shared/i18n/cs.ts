...
export const cs = {
  ...
  home: {
    ...
    featuresDescription: "Od výpočtu vaší mapy po pokročilé hloubkové rozbory – poskytujeme nejkomplexnější nástroje Human Designu v češtině.",
    ...
    features: {
      ...
      aiReadings: { title: "Hloubkový rozbor", description: "Komplexní personalizované interpretace. Analýza vašeho typu, profilu, autority a životního účelu." },
  ...
  chart: {
    ...
    // AI Reading
    aiReading: "Hloubkový rozbor",
    aiReadingDesc: "Získejte komplexní personalizovaný rozbor na základě vaší jedinečné mapy",
    generatingReading: "Připravuji váš hloubkový rozbor...",
    aiTypes: {
  ...
  incarnationCrossPage: {
    ...
    gate: "Brána",
    aiTitle: "Analýza vašeho životního poslání",
    aiDesc: "Hloubkový výklad inkarnačního kříže",
    aiButton: "Získat hloubkovou analýzu",
    aiLoginRequired: "Pro hloubkovou analýzu je potřeba přihlášení",
    aiLoginButton: "Přihlásit se a získat analýzu",
    aiGenerating: "Analyzuji váš inkarnační kříž…",
    aiRegenerate: "Analyzovat znovu",
  ...
  pricing: {
    ...
    creditPackDesc: "5 hloubkových rozborů bez předplatného",
    ...
    upgradePrompt: "Vyčerpali jste svůj 1 bezplatný hloubkový rozbor. Upgradujte na Premium pro neomezené výklady.",
    upgradePromptCredits: "Nemáte žádné zbývající kredity na rozbor.",
