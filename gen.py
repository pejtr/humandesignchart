...
# Define the first 6 articles that are already written well
first_articles = [
    {
        "slug": "andelska-cisla-pruvodce", "number": "∞", "title": "Andělská čísla: Kompletní průvodce významy od 0 do 9999",
        "category": "pruvodce"
    },
    # ... we will just append the rest to the existing array.
]
...
extra_numbers = [
    ...
    ("1144-vyznam", "1144", "Andělské číslo 1144: Využijte svůj potenciál", "manifestace", "Manifesting Generator - rychlý potenciál"),
...
# get the part of orig_content up to `];` containing the first articles
articles_block = orig_content.split("];")[0]
articles_block = articles_block.split("export const ANGEL_NUMBERS: AngelNumberArticle[] = [")[1]
js_code += articles_block
